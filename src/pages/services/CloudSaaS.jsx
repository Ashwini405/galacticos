...
const EnhancedCloudNetworkSVG = () => (
  <svg width="300" height="240" viewBox="0 0 300 240" style={{ overflow: "visible", filter: "drop-shadow(0 20px 30px rgba(102,126,234,0.35))" }}>
    <defs>
...
const EnhancedDataSVG = () => (
  <svg width="280" height="220" viewBox="0 0 280 220" style={{ overflow: "visible", filter: "drop-shadow(0 15px 25px rgba(102,126,234,0.25))" }}>
    <defs>
  ...
  return (
    <>
      ...
      <section style={styles.hero}>
        ...
        <div style={{ display: "flex", justifyContent: "center", alignItems: "center", animation: "fadeInUp 1.2s ease-out" }}>
          <EnhancedOrbitalSVG />
        </div>
      </section>
